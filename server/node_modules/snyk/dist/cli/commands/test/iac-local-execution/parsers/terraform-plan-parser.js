...
exports.FailedToExtractResourcesInTerraformPlanError = exports.MissingRequiredFieldsInTerraformPlanError = exports.FailedToParseTerraformPlanJsonError = exports.tryParsingTerraformPlan = void 0;
...
function assertRequiredFields(terraformPlanJson) {
    var _a;
    if (!((_a = terraformPlanJson.planned_values) === null || _a === void 0 ? void 0 : _a.root_module) ||
        terraformPlanJson.resource_changes === undefined) {
        throw new MissingRequiredFieldsInTerraformPlanError();
    }
}
function tryParsingTerraformPlan(terraformPlanFile, { isFullScan } = { isFullScan: false }) {
...
class FailedToParseTerraformPlanJsonError extends errors_1.CustomError {
    constructor(message) {
        super(message || 'Failed to parse Terraform plan JSON file');
        this.code = types_1.IaCErrorCodes.FailedToParseTerraformPlanJsonError;
        this.userMessage =
            'The Terraform plan file provided contains malformed JSON please regenerate it and try again';
    }
}
exports.FailedToParseTerraformPlanJsonError = FailedToParseTerraformPlanJsonError;
class MissingRequiredFieldsInTerraformPlanError extends errors_1.CustomError {
    constructor(message) {
        super(message || 'Failed to parse Terraform plan JSON file');
        this.code = types_1.IaCErrorCodes.MissingRequiredFieldsInTerraformPlanError;
        this.userMessage =
...
exports.MissingRequiredFieldsInTerraformPlanError = MissingRequiredFieldsInTerraformPlanError;
