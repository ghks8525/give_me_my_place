...
exports.FailedToFormatResults = exports.formatScanResults = void 0;
...
function formatScanResults(scanResults, options) {
    try {
        // Relevant only for multi-doc yaml files
        const scannedResultsGroupedByDocId = groupMultiDocResults(scanResults);
        return scannedResultsGroupedByDocId.map((iacScanResult) => formatScanResult(iacScanResult, options.severityThreshold));
    }
    catch (e) {
...
function formatScanResult(scanResult, severityThreshold) {
